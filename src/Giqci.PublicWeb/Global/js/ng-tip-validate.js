...
(function () {
	...
	.service("ngTipValidateConfig", function () {
	    this.uccRequireMsg = $giqci.KeyToWord("required");
	    this.uccPhoneMsg = $giqci.KeyToWord("cell_phone_format_error");
	    this.uccTelMsg = $giqci.KeyToWord("phone_format_error");
	    this.uccEmailMsg = $giqci.KeyToWord("email_format_error");
	    this.uccBankCardMsg = $giqci.KeyToWord("bank_card_format_error");
	    this.uccMinLengthMsg = $giqci.KeyToWord("length_should_not_be_less_than") + " $";
	    this.uccMaxLengthMsg = $giqci.KeyToWord("length_cannot_be_greater_than") + " $";
	    //错误提示的方向
