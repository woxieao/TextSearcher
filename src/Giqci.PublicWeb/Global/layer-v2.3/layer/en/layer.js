...
function (a, b) {
    ...
    f.prompt = function (a, b) {
        ...
        return f.open(c.extend({
            ...
            yes: function (c) {
                var e = d.val();
                "" === e ? d.focus() : e.length > (a.maxlength || 500) ? f.tips("maximum is " + (a.maxlength || 500) + "characters", d, {
                    tips: 1
                }) : b && b(e, c, d)
            }
        },
    ...
    f.photos = function (b, d, e) {
        ...
        b.photos) {
            ...
            if (h.imgIndex = (0 | m) + 1, b.img = b.img || "img", i) {
                if (0 === l.length) return f.msg("No image")
            } else {
                var n = c(b.photos),
                o = function () {
                    l = [],
            ...
            function () {
                f.close(h.loadi),
                f.msg("Image address error;<br>Continue to the next?", {
                    time: 3e4,
                    btn: ["Next", "Cancel"],
                    yes: function () {
